...
By downloading, installing, or using HydroTrack ("the App"), you agree to these Terms of Service ("Terms"). If you do not agree, do not use the App. The App is developed and operated by Fog Hill LLC ("we," "us," "our").

## 2. Description of Service

HydroTrack is a mobile application that helps you track your daily water and beverage intake. The App enables users to log hydration, set personalized goals, receive reminders, view analytics, and optionally sync with Apple Health. All data is stored locally on your device.
...
HydroTrack does not require account creation to use core features. If you purchase a subscription, your purchase is associated with your Apple ID and managed through Apple's App Store.

## 5. Subscriptions and Payments

### Free Tier

The App offers free functionality including basic hydration tracking with a limited selection of beverage types and 7-day history.

### Paid Subscriptions

- **HydroTrack Pro Monthly:** $1.99/month. Provides 30+ beverage types, full analytics, custom reminders, unlimited history, and data export.
- **HydroTrack Pro Annual:** $14.99/year. Same features as Pro Monthly at a discounted annual rate.
- **HydroTrack Pro Lifetime:** One-time purchase. Permanent access to all Pro features.
...
HydroTrack is designed for general wellness and hydration tracking purposes only. The App is not a medical device and is not intended to diagnose, treat, cure, or prevent any disease or medical condition. Always consult with a qualified healthcare professional regarding your hydration needs, especially if you have medical conditions that affect fluid intake.
...
You retain all rights to your hydration data. All data is stored locally on your device — we do not access or store your data on our servers.

## 9. Privacy

Your use of the App is governed by our Privacy Policy, available at [https://foggy-labs.github.io/privacy/hydrotrack/](https://foggy-labs.github.io/privacy/hydrotrack/). By using the App, you agree to our collection and use of data as described in the Privacy Policy.
...
- Hydration tracking results will meet your specific health requirements
