...
By downloading, installing, or using CleanSnap ("the App"), you agree to these Terms of Service ("Terms"). If you do not agree, do not use the App. The App is developed and operated by Fog Hill LLC ("we," "us," "our").

## 2. Description of Service

CleanSnap is a mobile application that uses on-device AI to clean, enhance, and organize your photos. The App enables users to remove unwanted objects, enhance photo quality, and manage their photo library using Apple's on-device machine learning frameworks. No photos are uploaded to external servers.
...
CleanSnap does not require account creation to use core features. If you purchase a subscription, your purchase is associated with your Apple ID and managed through Apple's App Store.

## 5. Subscriptions and Payments

### Free Tier

The App offers free functionality including basic photo cleanup tools with usage limits.

### Paid Subscriptions

- **CleanSnap Pro Monthly:** $4.99/month. Provides unlimited photo cleanup, all AI enhancement tools, and priority processing.
- **CleanSnap Pro Annual:** $29.99/year. Same features as Pro Monthly at a discounted annual rate.
...
- Upload, process, or distribute content that is illegal, harmful, or violates the rights of any person
- Attempt to reverse engineer, decompile, or disassemble any part of the App
- Use the App to process photos of individuals without their consent in violation of applicable privacy laws
...
You retain all rights to your photos. By using the App to process your photos, you grant us no license to your photos — all processing occurs on your device and we never access or store your photos.

## 8. Privacy

Your use of the App is governed by our Privacy Policy, available at [https://foggy-labs.github.io/privacy/cleansnap/](https://foggy-labs.github.io/privacy/cleansnap/). By using the App, you agree to our collection and use of data as described in the Privacy Policy.
...
- Photo processing results will meet your specific requirements or expectations

## 10. Limitation of Liability

TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, FOG HILL LLC SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF DATA, LOSS OF PHOTOS, OR LOSS OF PROFITS, ARISING FROM YOUR USE OF THE APP, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
