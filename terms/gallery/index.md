...
By downloading, installing, or using Gallery ("the App"), you agree to these Terms of Service ("Terms"). If you do not agree, do not use the App. The App is developed and operated by Fog Hill LLC ("we," "us," "our").
...
You retain all rights to the activity data you create in the App (saved exhibitions, visit logs, follows). All such data is stored locally on your device and we never access or store it on our servers.

## 9. Privacy

Your use of the App is governed by our Privacy Policy, available at [https://foggy-labs.github.io/privacy/gallery/](https://foggy-labs.github.io/privacy/gallery/). By using the App, you agree to our collection and use of data as described in the Privacy Policy.
